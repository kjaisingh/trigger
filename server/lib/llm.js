...
- gmail: { "from": string } — a sender's name or email address to watch for
...
- crypto: price_usd
- gmail: message_received (threshold is always true, operator is always "==")
